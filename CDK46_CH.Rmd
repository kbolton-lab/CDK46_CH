...
default_sig <- function(y_position, xmin, xmax, model_pvalue, model_stars, tip_length = 0.03, size = 1, textsize = 10, color = "black", show_values = TRUE, hide_ns = TRUE) {
  if (show_values){
    list(y_position = y_position, xmin = c(xmin), xmax = c(xmax), annotation = paste0(format(model_pvalue, digits = 2), model_stars), tip_length = tip_length, size = size, textsize = textsize, color = color)
  } else {
...
default_sig_data <- function(data, y_position, xmin, xmax, model_pvalue, model_stars, tip_length = 0.03, size = 1, textsize = 10, color = "black", show_values = TRUE, hide_ns = TRUE) {
  if (show_values) {
    list(data = data, y_position = y_position, xmin = c(xmin), xmax = c(xmax), annotation = paste0(format(model_pvalue, digits = 2), model_stars), tip_length = tip_length, size = size, textsize = textsize, color = color)
  } else {
    if (model_stars == "") { model_stars <- "ns"}
    if (hide_ns & model_stars == "ns") { 
...
fig1d <- df_to_plot %>%
    ...
    scale_fill_nejm()
fig1d
ggsave(paste0(figures_save_path, "Figure1D.png"), plot = fig1d, width = 8, height = 10, dpi = 300)
```
...
model_treatment_binary_gene <- map_dfr(c(gene_list), function(gene){
    glm(
        ...
        data = g1_mut_table %>%
            filter(whichdraw == "PostTx") %>%
            mutate(Treatment = ifelse(Trilaciclib == "Untreated", "Healthy Control", "SCLC Post-Treatment"))
    ) %>%
    sjPlot::get_model_data(type = "est") %>%
    mutate(Gene = gene)
})
...
fig1e_cont <- g1_mut_table %>%
    ...
    do.call(geom_signif, default_sig(0.65, 0.75, 1.25, model_treatment_gene_class$p.value[1], model_treatment_gene_class$p.stars[1], tip_length = 0.1, size = 1.5, show_values = FALSE, hide_ns = FALSE)) +
    do.call(geom_signif, default_sig(0.65, 1.75, 2.25, round(model_treatment_gene_class$p.value[2], 2), model_treatment_gene_class$p.stars[2], tip_length = 0.1, size = 1.5, show_values = TRUE, hide_ns = FALSE))
fig1e_cont
...
fig1f <- df_to_plot %>%
    ...
    scale_fill_manual(values = treatment_colors) +
    do.call(geom_signif, default_sig_data(df_to_plot, 5, 0.75, 1, model_growth_rate_class$p.value[1], model_growth_rate_class$p.stars[1], show_values = FALSE, textsize = 8, size = 2)) +
    do.call(geom_signif, default_sig_data(df_to_plot, 6, 0.75, 1.25, model_growth_rate_class$p.value[2], model_growth_rate_class$p.stars[2], show_values = FALSE, textsize = 8, size = 2)) +
    do.call(geom_signif, default_sig_data(df_to_plot, 7, 1, 1.25, model_growth_rate_class$p.value[5], model_growth_rate_class$p.stars[5], show_values = FALSE, textsize = 8, size = 2)) +
...
fig1f
ggsave(paste0(figures_save_path, "Figure1F.png"), plot = fig1f, width = 14, height = 14, dpi = 300)
```
...
fig2c <- df_to_plot %>%
    ...
    do.call(geom_signif, default_sig_data(df_to_plot, 7, 2, 2.25, model_growth_rate_class$p.value[6], model_growth_rate_class$p.stars[6], show_values = TRUE, textsize = 8, size = 2))
fig2c
ggsave(paste0(figures_save_path, "Figure2C.png"), plot = fig2c, width = 10, height = 8, dpi = 300)
```
...
fig2d <- df_to_plot %>%
    ...
    do.call(geom_signif, default_sig_data(df_to_plot, 7, 2, 2.25, model_growth_rate_class$p.value[6], model_growth_rate_class$p.stars[6], show_values = TRUE, textsize = 8, size = 2))
fig2d
ggsave(paste0(figures_save_path, "Figure2D.png"), plot = fig2d, width = 10, height = 8, dpi = 300)
```
...
fig2e <- df_to_plot %>%
    ...
    scale_y_continuous(trans = scales::pseudo_log_trans(0.001), breaks = c(-0.05, -0.01, -0.005, 0, 0.005, 0.01, 0.05), limit = c(NA, 1.5)) +
    scale_fill_manual(values = treatment_colors) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*TP53*"), 5, 0.75, 1, model_growth_rate_gene$p.value[1], model_growth_rate_gene$p.stars[1], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*TP53*"), 6, 0.75, 1.25, model_growth_rate_gene$p.value[2], model_growth_rate_gene$p.stars[2], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*TP53*"), 7, 1, 1.25, model_growth_rate_gene$p.value[7], model_growth_rate_gene$p.stars[7], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*PPM1D*"), 5, 1.75, 2, model_growth_rate_gene$p.value[3], model_growth_rate_gene$p.stars[3], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) + 
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*PPM1D*"), 6, 1.75, 2.25, model_growth_rate_gene$p.value[4], model_growth_rate_gene$p.stars[4], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*PPM1D*"), 7.1, 2, 2.25, model_growth_rate_gene$p.value[8], model_growth_rate_gene$p.stars[8], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*CHEK2*"), 5, 2.75, 3, model_growth_rate_gene$p.value[5], model_growth_rate_gene$p.stars[5], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*CHEK2*"), 6, 2.75, 3.25, model_growth_rate_gene$p.value[6], model_growth_rate_gene$p.stars[6], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
    do.call(geom_signif, default_sig_data(df_to_plot %>% filter(Gene == "*CHEK2*"), 7.1, 3, 3.25, model_growth_rate_gene$p.value[9], model_growth_rate_gene$p.stars[9], show_values = TRUE, hide_ns = FALSE, textsize = 10, size = 3)) +
...
fig2e
ggsave(paste0(figures_save_path, "Figure2E.png"), plot = fig2e, width = 16, height = 12, dpi = 300)
...
ext_fig_tp53 <- df_to_plot %>%
    ...
    scale_y_continuous(trans = scales::pseudo_log_trans(0.001), breaks = c(-0.05, -0.01, -0.005, 0, 0.005, 0.01, 0.05), limit = c(NA, 1.5)) +
    scale_fill_manual(values = treatment_colors) +
    do.call(geom_signif, default_sig_data(df_to_plot, 5, 0.75, 1, model_growth_rate_variant_class$p.value[1], model_growth_rate_variant_class$p.stars[1], show_values = TRUE, hide_ns = FALSE, textsize = 8, size = 2)) +
    do.call(geom_signif, default_sig_data(df_to_plot, 6, 0.75, 1.25, model_growth_rate_variant_class$p.value[2], model_growth_rate_variant_class$p.stars[2], show_values = TRUE, hide_ns = FALSE, textsize = 8, size = 2)) +
    do.call(geom_signif, default_sig_data(df_to_plot, 7, 1, 1.25, model_growth_rate_variant_class$p.value[5], model_growth_rate_variant_class$p.stars[5], show_values = TRUE, hide_ns = FALSE, textsize = 8, size = 2)) +
    do.call(geom_signif, default_sig_data(df_to_plot, 5, 1.75, 2, model_growth_rate_variant_class$p.value[3], model_growth_rate_variant_class$p.stars[3], show_values = TRUE, hide_ns = FALSE, textsize = 8, size = 2)) +
    do.call(geom_signif, default_sig_data(df_to_plot, 6, 1.75, 2.25, model_growth_rate_variant_class$p.value[4], model_growth_rate_variant_class$p.stars[4], show_values = TRUE, hide_ns = FALSE, textsize = 8, size = 2)) +
    do.call(geom_signif, default_sig_data(df_to_plot, 7, 2, 2.25, model_growth_rate_variant_class$p.value[6], model_growth_rate_variant_class$p.stars[6], show_values = TRUE, hide_ns = FALSE, textsize = 8, size = 2))
ext_fig_tp53
...
cv_plot
ggsave("/Users/chani/Library/CloudStorage/Box-Box/Irenaeus/CDK46_CH/figures/cv_plot.png", cv_plot, width = 6, height = 8)
...
cv_combined_plot <- coefficient_of_variation_combined %>%
    ...
    geom_signif(y_position = 1.5, xmin = 1, xmax = 2, annotation = paste0("p = ", format(cv_stats$p.value[1], digits = 2), cv_stats$p.stars[1]), tip_length = 0.01, textsize = 5)
cv_combined_plot
ggsave("/Users/chani/Library/CloudStorage/Box-Box/Irenaeus/CDK46_CH/figures/rel_cv_combined_plot.png", cv_combined_plot, width = 6, height = 8)
...
ggsave("/Users/chani/Library/CloudStorage/Box-Box/Irenaeus/CDK46_CH/figures/SupplementalFigure4.png", supp_fig4, width = 12, height = 8)
```