...
untreated_df <- fread(paste0(re_data_file_path, "untreated_df.minimum.csv"))                # Untreated
...
axis_ticks <- c(0.0001, 0.0003, 0.0005, 0.001, 0.0020, 0.005, 0.01, 0.020, 0.05, 0.1)
...
supp_fig3 <- bio_fig4_data %>%
    ...
    labs(
        title = "Replicate Correlation of CH VAFs < 10%",
        color = "Reason", 
        x = "Replicate 1 - VAF",
        y = "Replicate 2 - VAF"
    ) +
