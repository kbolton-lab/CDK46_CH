...
p <- oncoPrint(mat,
    ...
    bottom_annotation = HeatmapAnnotation(
        ...
        col = list(
            Cohort = c(`Healthy Control` = col[1], `SCLC Pre-Treatment` = col[2]),
            Treatment = c(Untreated = col[1], Trilaciclib = col[2], Placebo = col[3])
        ),
...
data_to_plot %>%
    ...
    do.call(geom_signif, default_sig_data(data_to_plot %>% filter(Cohort == "SCLC"), 6, 1, 2, model_change_in_VAF_per_month$p.value[1], model_change_in_VAF_per_month$p.stars[1], show_values = TRUE)) +
    do.call(geom_signif, default_sig_data(data_to_plot %>% filter(Cohort == "TNBC"), 7, 1, 3, model_change_in_VAF_per_month$p.value[2], model_change_in_VAF_per_month$p.stars[2], show_values = TRUE)) +
    do.call(geom_signif, default_sig_data(data_to_plot %>% filter(Cohort == "CRC"), 8, 2.8, 3.2, model_change_in_VAF_per_month$p.value[3], model_change_in_VAF_per_month$p.stars[3], show_values = TRUE))
