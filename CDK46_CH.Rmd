...
g1_demo <- fread(paste0(data_file_path, "g1_demo.test.csv"))
...
# Small change to remove Missense Variants for PPM1D from the raw data
...
# There are only 2 values which when rounded to the nearest 0.001 are consistent
```
...
df_to_plot <- df_to_plot %>%
    mutate(
        growth_rate = log10(postVAF/preVAF) / change_in_days
    )
